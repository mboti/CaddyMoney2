-- Improve error messages for pay_payment_intent_with_category.
--
-- The original function intentionally swallowed all errors and returned a generic
-- "Payment failed" string. That makes it impossible for the client to show a
-- helpful error or for us to debug RLS/constraint failures.
--
-- This migration keeps the safe user-facing message but includes SQLSTATE and
-- SQLERRM as extra fields for debugging.
